...
def index(
    ...
    team_options = [
        ...
        {"label": "T1", "value": "T1", "patterns": ["Ampliaciones T1"]},
        {"label": "T2", "value": "T2", "patterns": ["Ampliaciones T2"]},
        {"label": "T3", "value": "T3", "patterns": ["Ampliaciones T3"]},
        {"label": "T4", "value": "T4", "patterns": ["Ampliaciones T4"]},
    ]
